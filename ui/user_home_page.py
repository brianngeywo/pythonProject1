...
class UserHomepage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button5 = ttk.Button(self, text="Switch Account",
        ...
        # Steps of how the platform work
