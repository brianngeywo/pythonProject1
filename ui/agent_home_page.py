...
class AgentHomepage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        platform_label.grid(row=1, columnspan=4, padx=10, pady=10)
        ...
        platform_description.grid(row=2, columnspan=4, padx=10, pady=10)

        # Steps of how the platform works
        step1_label = ttk.Label(self, text="Step 1: Register as an agent", font=MEDIUMFONT)
        step1_label.grid(row=3, columnspan=4, padx=10, pady=10)
        ...
        step1_description.grid(row=4, columnspan=4, padx=10, pady=10)

        step2_label = ttk.Label(self, text="Step 2: View requests", font=MEDIUMFONT)
        step2_label.grid(row=5, columnspan=4, padx=10, pady=10)
        ...
        step2_description.grid(row=6, columnspan=4, padx=10, pady=10)

        step3_label = ttk.Label(self, text="Step 3: Find a suitable house", font=MEDIUMFONT)
        step3_label.grid(row=7, columnspan=4, padx=10, pady=10)
        ...
        step3_description.grid(row=8, columnspan=4, padx=10, pady=10)

        step4_label = ttk.Label(self, text="Step 4: Upload the property", font=MEDIUMFONT)
        step4_label.grid(row=9, columnspan=4, padx=10, pady=10)
        ...
        step4_description.grid(row=10, columnspan=4, padx=10, pady=10)

        step5_label = ttk.Label(self, text="Step 5: Notify the foreign user", font=MEDIUMFONT)
        step5_label.grid(row=11, columnspan=4, padx=10, pady=10)
        ...
        step5_description.grid(row=12, columnspan=4, padx=10, pady=10)

        step6_label = ttk.Label(self, text="Step 6: Foreign user accepts or declines", font=MEDIUMFONT)
        step6_label.grid(row=13, columnspan=4, padx=10, pady=10)
        ...
        step6_description.grid(row=14, columnspan=4, padx=10, pady=10)

        step7_label = ttk.Label(self, text="Step 7: Payment", font=MEDIUMFONT)
        step7_label.grid(row=15, columnspan=4, padx=10, pady=10)
        ...
        step7_description.grid(row=16, columnspan=4, padx=10, pady=10)

        step8_label = ttk.Label(self, text="Step 8: Leave a review", font=MEDIUMFONT)
        step8_label.grid(row=17, columnspan=4, padx=10, pady=10)
        ...
        step8_description.grid(row=18, columnspan=4, padx=10, pady=10)
